...
if funnel_1_TAC["TAC1_Freq"] < 50 or funnel_1_TAC["TAC1_Freq"] > 62:
    #Add error code 1 to error list
    Error_list.append(1)

#Check to see if any errors with F1_2
if funnel_1_TAC["TAC2_Freq"] < 48 or funnel_1_TAC["TAC2_Freq"] > 60:
...
if funnel_2_TAC["TAC1_Freq"] < 48 or funnel_2_TAC["TAC1_Freq"] > 60:
    #Add error code 4 to error list
    Error_list.append(4)

#Check to see if any errors with F2_2
if funnel_2_TAC["TAC2_Freq"] < 50 or funnel_2_TAC["TAC2_Freq"] > 60:
...
if funnel_3_TAC["TAC1_Freq"] < 48 or funnel_3_TAC["TAC1_Freq"] > 59:
    #Add error code 7 to error list
    Error_list.append(7)

#Check to see if any errors with F3_2
if funnel_3_TAC["TAC2_Freq"] < 48 or funnel_3_TAC["TAC2_Freq"] > 60:
...
if funnel_4_TAC["TAC1_Freq"] < 48 or funnel_4_TAC["TAC1_Freq"] > 60:
    #Add error code 10 to error list
    Error_list.append(10)

#Check to see if any errors with F4_2
if funnel_4_TAC["TAC2_Freq"] < 48 or funnel_4_TAC["TAC2_Freq"] > 60:
